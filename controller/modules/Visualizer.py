...
class Visualizer(ControllerModule):

    def __init__(self, CFxHandle, paramDict, ModuleName):
        super(Visualizer, self).__init__(CFxHandle, paramDict, ModuleName)
        '''
        self.vis_address = (
        ...
        self.vis_address = "http://"+self.CMConfig["visualizerweb_addr"]
